...
const ServiceInfo = () => {
  const infoData = [
    { id: 1,path:"mars-solutions/manufacturing-excellence-hub" , title: "MANUFACTURING EXCELLENCE", subtitle: "", iconImg: serviceicon1, details: "Precision built Ready Made and custom truck containers manufactured using advanced fabrication methods, quality materials, and skilled craftsmanship for reliable transportation solutions.", linkText: "Explore On Service", linkSymbol: "↗" },
